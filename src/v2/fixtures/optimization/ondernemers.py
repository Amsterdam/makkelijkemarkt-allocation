...
vpls = [
    ...
    Ondernemer(rank=3, branche=branche_2, prefs=[6, 7], min=1, max=2, anywhere=False, status=Status.VPL, own=[4]),
    Ondernemer(rank=4, branche=branche_2, prefs=[4, 5], min=1, max=2, anywhere=False, status=Status.VPL, own=[6]),
]
