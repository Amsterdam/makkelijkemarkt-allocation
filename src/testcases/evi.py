...
class TestEVI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        dp.add_merchant(erkenningsNummer='1',
                        ...
                        voorkeur={"branches": ['404-parfum'], "maximum": 2, "minimum": 2,
                                  "verkoopinrichting":['eigen-materieel'], "absentFrom":"", "absentUntil": ""})
        ...
        dp.add_merchant(erkenningsNummer='2',
                        ...
                        voorkeur={"branches": ['mooie spullen'], "maximum": 1, "minimum": 1,
                                  "verkoopinrichting":['eigen-materieel'], "absentFrom":"", "absentUntil": ""})

        # stands
        dp.add_page(['1', '2', '3', '99', '100', '101', '103'])
        dp.add_stand(plaatsId='1', branches=[], properties=[], verkoopinrichting=['eigen-materieel'])
        ...
        dp.add_stand(plaatsId='99', branches=[], properties=[], verkoopinrichting=['eigen-materieel'])
        dp.add_stand(plaatsId='100', branches=[], properties=[], verkoopinrichting=[])
        dp.add_stand(plaatsId='101', branches=[], properties=[], verkoopinrichting=['eigen-materieel'])
        dp.add_stand(plaatsId='103', branches=[], properties=[], verkoopinrichting=['eigen-materieel'])
    ...
    def test_can_only_be_at_evi_stand(self):
        ...
        self.assertListEqual(self.market_allocation['toewijzingen'][1]['plaatsen'], ['101', '103'])
    ...
    def test_most_suitable_stand(self):
        ...
        self.dp.add_merchant(erkenningsNummer='55',
                        plaatsen=[],
                        status='soll',
                        sollicitatieNummer="2",
        ...
        allocator = Allocator(self.dp)
        self.market_allocation = allocator.get_allocation()
        self.assertListEqual(self.market_allocation['toewijzingen'][1]['plaatsen'], ['3'])
    ...
    def test_can_not_expand_to_non_evi_stand(self):
        ...
        allocator = Allocator(self.dp)
        self.market_allocation = allocator.get_allocation()
        self.assertListEqual(self.market_allocation['toewijzingen'][0]['plaatsen'], ['1'])
