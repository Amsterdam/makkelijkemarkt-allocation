...
class TestBasicAllocation(unittest.TestCase):
    ...
    def test_assign_standwerker(self):
        ...
        self.dp.add_stand(plaatsId='9', branches=['401-experimentele-zone'], properties=[], verkoopinrichting=[], inactive=False)
        self.dp.add_stand(plaatsId='3', branches=[], properties=[], verkoopinrichting=[], inactive=False)
        self.dp.add_stand(plaatsId='4', branches=[], properties=[], verkoopinrichting=[], inactive=False)
        self.dp.add_stand(plaatsId='5', branches=[], properties=[], verkoopinrichting=[], inactive=False)
    ...
    def test_assign_unused_baking_stand(self):
        ...
        self.dp.add_merchant(erkenningsNummer='244',
                             ...
                             voorkeur={"branches": ['vacuumslangen'], "maximum": 1, "minimum": 1,
    ...
    def test_assign_unused_evi_stand(self):
        ...
        self.dp.add_page(['7'])
        self.dp.add_rsvp(erkenningsNummer='244', attending=True)
        self.dp.add_stand(plaatsId='7', branches=['bak'], properties=[], verkoopinrichting=['eigen-materieel'], inactive=False)
        self.dp.add_branche(brancheId="bak", verplicht=True, maximumPlaatsen=12)
        self.dp.mock()
    ...
    def test_assign_rejected_stand(self):
        ...
        """
        self.dp.add_merchant(erkenningsNummer='23',
                             plaatsen=[],
                             status='soll',
                             sollicitatieNummer="6",
                             description='G. Rootheidswaanzin',
                             voorkeur={"branches": ['vacuumslangen'], "maximum": 23, "minimum": 22,
                                       "verkoopinrichting": [], "absentFrom": "", "absentUntil": ""})

        self.dp.add_merchant(erkenningsNummer='24',
                             plaatsen=[],
                             status='soll',
                             sollicitatieNummer="6",
        ...
        self.dp.add_stand(plaatsId='3', branches=['bak'], properties=[], verkoopinrichting=['eigen-materieel'], inactive=False)
        self.dp.add_stand(plaatsId='4', branches=['bak'], properties=[], verkoopinrichting=['eigen-materieel'], inactive=False)
        self.dp.add_stand(plaatsId='5', branches=[], properties=[], verkoopinrichting=[], inactive=False)
        self.dp.add_stand(plaatsId='6', branches=[], properties=[], verkoopinrichting=[], inactive=False)
        self.dp.add_stand(plaatsId='7', branches=[], properties=[], verkoopinrichting=[], inactive=False)
